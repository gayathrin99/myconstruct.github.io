...
<br>
  <p style="font-size:30px" align="center">Monitoring 24/7 with your camera!</p>
  <br>
         
<br>
<input type="email" name="emailid" id="emailid" required />
        <br>
        <p font-size="100px">Enter your mail address to check the tool! </p>
        <br>
<input type ="submit" name="check it" value="Submit" id="submitbutton" style="height:50px; width: 100px;background-color:Orange;font-size:20px; border:none" onclick="show()"/>
...
{
    {
       ...
       $from="consultmy@gmail.com";
         ...
         $headers .= "From: constructmy@gmail.com". "\r\n" . "CC: constructmy@gmail.com";
