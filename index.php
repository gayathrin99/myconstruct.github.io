...
<br>
  <p style="font-size:30px" align="center">Get quotes from atleast 3 Civil Engineers for your project!</p>
  <br>
  <h2> Get consultants who have been decades in the industry</p>       
<br>
<div class="column-4 project">
  <h2 class="project-text"><a href="person-1.php"> Vishvas Mithraas</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-2.php">Galagali Associates</a></h2>
</div>

<div class="column-4 project">
  <h3 class="project-text"><a href="person-3.php">SVS Engineers</a></h3>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-4.php">Imprints Architects</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-5.php">SP Associates</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-6.php">Abhaya Associates</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-7.php">AA Associates</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-8.php">Satya Illindra</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-9.php">VR Infra Solutions</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-10.php">Samyak Engineering</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-11.php">Erusu Consultants</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-12.php">Alliance Structures</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-13.php">Civil AID</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-14.php">Aster Consultancy</a></h2>
</div>

<div class="column-4 project">
  <h2 class="project-text"><a href="person-15.php">CE Consultants</a></h2>
</div>
